...
{{fig:fig6_number_histogram|The full jersey-number distribution, one season at a time: drag the slider or press play to walk 45 seasons. This is the exploratory view the medians compress away: when exactly one player wore a number that season, hovering the bar names him. Watch the high-number right tail thin out and the 0/00 bar (first bar, pooled) grow from 1.1% of the league in 1980-81 to 6.8% in 2024-25, its all-time peak. Numbers 50 and up went from 7.7% of players to 4.7%.}}
